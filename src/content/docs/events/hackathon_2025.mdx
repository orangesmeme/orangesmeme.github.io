...
<div class="flex justify-center w-full">
  <div class="flex flex-col items-center justify-center p-4 text-center max-w-96 leading-3">
    [<Image src={moojLogo} alt="Sponsors" class="size-32" />](https://moonjuicealgo.site/)
