...
Prize pool currently at over 10,000 ORA and contributions from sponsors (MOOJ, COMPX, VEST, ANGRY, BERB, and more!). This will continue to grow throughout the hackathon!
...
<div class="grid md:grid-cols-2 w-full">
  ...
  <div class="flex flex-col items-center p-4 text-center max-w-96 [&>*]:m-0">
    [<Image src={moojLogo} alt="Moon Juice (MOOJ)" class="size-32" />](https://moonjuicealgo.site/)
    <div class="font-bold text-2xl">Moon Juice (MOOJ)</div>
    <div>The Deflationary Hold-to-Earn ASA.</div>
    <div style={{ marginTop: "0 !important" }}>Learn more at [https://moonjuicealgo.site/](https://moonjuicealgo.site/)!</div>
  </div>

  <div class="flex flex-col items-center p-4 text-center max-w-96" style={{ marginTop: "0 !important" }}>
    <div class="bg-white">[<Image src={compxLogo} alt="CompX" class="size-32" />](https://compx.io/)</div>
    <div class="font-bold text-2xl">CompX</div>
    <div>Powering the next DeFi revolution.</div>
    <div style={{ marginTop: "0 !important" }}>Learn more at [https://compx.io/](https://compx.io/)!</div>
  </div>
